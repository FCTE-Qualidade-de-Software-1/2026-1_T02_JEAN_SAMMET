# README - Projeto Jean Sammet T02 (*AcheiUnB*)

**Produto Avaliado:** O produto avaliado pela equipe *Jean Sammet* (T02) no semestre 2026.1 foi o website *AcheiUnB*, um projeto desenvolvido para facilitar a vida dos estudantes da *Universidade de Brasília (UnB)* na busca e recuperação de itens perdidos. A plataforma permite que os alunos registrem e encontrem objetos, facilitando o contato entre quem perdeu e encontrou o item. O seu objetivo é reduzir a dependência de grupos de mensagens e proporcionar um sistema mais organizado e acessível para achados e perdidos. A escolha deste produto se justifica por sua relevância no ambiente de docência, visto que é oriundo dos esforços de alunos interessados em contribuir com a comunidade da UnB.
...
1. Maturidade: capacidade do produto atingir as necessidades de confiabilidade;
2. Disponibilidade: se um sistema, produto ou componente está acessível e operante;
3. Tolerância a falhas: capacidade de um sistema, produto ou componente operar apesar de falhas de hardware e/ou software;
4. Recuperabilidade: capacidade de recuperar dados em uma possível falha ou interrupção.
...
1. Modularidade: programas ou sistemas podem sofrer mudanças sem impactar em outros componentes;
2. Reusabilidade: capacidade de um recurso poder ser utilizado em mais de um sistema;
3. Analisabilidade: capacidade de diagnosticar problemas ou causas de falhas, assim como partes a serem modificadas;
4. Modificabilidade: capacidade de um produto ou sistema ser modificado sem introduzir defeitos ou diminuir a qualidade atual;
5. Testabilidade: efetividade de testes para o sistema, produto ou componente.
...
<div align="center">
  <table align="center">
    <tr>
      <td align="center">
        <a href="https://github.com/Withy-S">
          <img style="border-radius: 50%; border: 3px solid #4CAF50;" src="https://github.com/Withy-S.png" width="120px;" alt="Davi Leite"/>
        </a><br />
        <sub><b>Davi Leite</b></sub><br/>
      </td>
      <td align="center">
        <a href="https://github.com/Diogo-Olivv">
          <img style="border-radius: 50%; border: 3px solid #4CAF50;" src="https://github.com/Diogo-Olivv.png" width="120px;" alt="Diogo Oliveira"/>
        </a><br />
        <sub><b>Diogo Oliveira</b></sub><br/>
      </td>
      <td align="center">
        <a href="https://github.com/eduardodpms">
          <img style="border-radius: 50%; border: 3px solid #4CAF50;" src="https://github.com/eduardodpms.png" width="120px;" alt="Eduardo de Pina"/>
        </a><br />
        <sub><b>Eduardo de Pina</b></sub><br/>
      </td>
      <td align="center">
        <a href="https://github.com/Potatoyz908">
          <img style="border-radius: 50%; border: 3px solid #4CAF50;" src="https://github.com/Potatoyz908.png" width="120px;" alt="Euller Júlio"/>
        </a><br />
        <sub><b>Euller Júlio</b></sub><br/>
      </td>
      <td align="center">
        <a href="https://github.com/JMPNascimento">
          <img style="border-radius: 50%; border: 3px solid #4CAF50;" src="https://github.com/JMPNascimento.png" width="120px;" alt="João Nascimento"/>
        </a><br />
        <sub><b>João Nascimento</b></sub><br/>
      </td>
       <td align="center">
        <a href="https://github.com/Wooo589">
          <img style="border-radius: 50%; border: 3px solid #4CAF50;" src="https://github.com/Wooo589.png" width="120px;" alt="Willian Silva"/>
        </a><br />
        <sub><b>Willian Silva</b></sub><br/>
      </td>
    </tr>
  </table>
</div>
