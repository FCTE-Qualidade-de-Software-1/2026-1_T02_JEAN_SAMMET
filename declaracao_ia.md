...
Os conteúdos gerados por IA foram empregados exclusivamente como material de apoio e ponto de partida para discussão e desenvolvimento das análises. Todo o material produzido foi posteriormente revisado, validado e adaptado pelos integrantes do grupo, que permaneceram responsáveis pela seleção das informações, pela verificação de sua precisão e pelas conclusões apresentadas.

Além disso, nesse trabalho, não foi utilizada *IA* para **geração de imagens**, **geração de dados de medição**, **definição e priorização de características/subcaracterísticas de qualidade**, **definição de objetivos, questões ou métricas GQM** ou **execução da coleta de dados**.

<br>

## Ferramentas

Segue abaixo, na **Tabela 1**, uma listagem das principais ferramentas baseadas em Inteligência Artificial utilizadas pela equipe.


<div align="center">

**Tabela 1:** Ferramentas de IA utilizadas

| Ferramenta | Owner | Link |
| :-: | :-: | :-: |
...
**Tabela 2:** Uso de IA por membro na EU1
...
## Entrega 2 (Fases 2, 3 e 4 e Correções da Entrega 1)

<div align="center">

**Tabela 3:** Uso de IA por membro na EU2
...
## Entrega 3 (Correções da Entrega 2)

<div align="center">

**Tabela 4:** Uso de IA por membro na EU3
