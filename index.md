# Projeto Jean Sammet: Análise de Qualidade do AcheiUnB

Bem-vindo à página de documentação do nosso projeto de análise de qualidade de software, focado no sistema **AcheiUnB**.

O AcheiUnB é uma aplicação web de código aberto voltada ao gerenciamento de achados e perdidos da Universidade de Brasília (UnB). A escolha deste produto se justifica por sua relevância no ambiente acadêmico, permitindo que estudantes registrem e encontrem objetos perdidos de forma organizada e centralizada, reduzindo a dependência de grupos informais de mensagens.
